      ...
      <div class="main-container">
        ...
        <div class="side-bar-container">
          <div class="side-bar">
              ...
              <div class="modal-container" @click.stop="">
                ...
                <ul>
                  <li v-for="info in list">
                    {{ info.storeName }}
                    <button @click="pickUpStoreSelect(info.storeId)" class="modal-button">
                      선택
                    </button>
                  </li>
                </ul>
            ...
            <div class="">
              <vue-date-picker v-model="pickUpDate" locale="ko"></vue-date-picker>
            </div>
            <div>
              <button v-if="" @click="showToastMessage" class="side-button font-size2">
                장바구니
              </button>
            </div>
            <div>
              <button class="side-button font-size2" @click="fnPayment">바로 구매하기</button>
            </div>
