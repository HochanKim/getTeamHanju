        ...
        <div class="joincontent">
          ...
          <div class="ex2">
            ...
            <div class="content">
              <p>이용약관</p>
              <p>
                본 약관은 ooo(전자상거래 사업자)(이하 “회사”)가 운영하는
                인터넷사이트 한주(이하 “한주”)에서 제공하는 전자상거래 관련 모든
                서비스(이하 “서비스”)를 이용함에 있어 한주와 이용자의 권리,
                의무, 책임사항 및 기타 필요한 사항을 규정함을 목적으로 한다.
              </p>
              <br />

              <p>제1조(목적)</p>
              <p>
                본 약관은 한주에서 제공하는 전자상거래 관련 서비스 이용에 대한
                권리, 의무, 책임사항을 규정한다.
              </p>
              <br />
              ...
              <br />
              <p>
                한주: 회사가 재화 또는 용역을 이용자에게 제공하기 위해 설정한
                가상의 영업장 및 서비스를 운영하는 사업자.
              </p>
              <p>
                이용자: 본 약관에 따라 한주가 제공하는 서비스를 받는 회원 및
                비회원.
              </p>
              <p>
                회원: 한주에 개인정보를 제공하여 회원 등록을 한 자로, 서비스를
                이용할 수 있는 자.
              </p>
              <p>
                비회원: 회원에 가입하지 않고 한주가 제공하는 서비스를 이용하는
                자.
              </p>
              <p>
                가입: 한주가 제공하는 신청서 양식에 정보를 기입하고 본 약관에
                동의하여 서비스 이용계약을 완료하는 행위.
              </p>
              <p>
                콘텐츠: 회사 또는 이용자가 서비스 상에 게시 또는 등록하는 모든
                글, 사진, 동영상 등.
              </p>
              <br />
              ...
              <p>
                한주는 본 약관의 내용을 초기 서비스화면에 게시하며, 개정 시에는
                적용일자 및 개정사유를 공지한다.
              </p>
              <br />
              <p>
                약관 개정 시, 이용자는 개정된 약관에 동의하지 않을 경우
                회원등록을 취소할 수 있다.
              </p>
              ...
              <p>
                한주는 다음과 같은 업무를 수행하며, 재화 또는 용역의 품절 및
                기술적 사양 변경 시 공지한다.
              </p>
              <br />
              ...
              <p>제5조(서비스의 중지)</p>
              <p>
                서비스의 제공이 중단될 경우, 한주는 손해에 대해 배상하되, 고의
                또는 과실이 없음을 입증하는 경우는 제외된다.
              </p>
              <br />
              <p>
                컴퓨터 등 정보통신설비의 보수점검, 고장, 통신의 차단 등의 사유
                발생 시 서비스 중단
              </p>
              <p>
                서비스 제공을 중단하게 되는 경우, 이용자에게 통지하고 보상 조건
                제시
              </p>
              <p>
                회원의 본 약관 위반 시, 서비스 사용을 제한 및 중지할 수 있다.
              </p>
              <br />

              <p>제6조(회원가입)</p>
              <p>
                이용자는 한주가 정한 양식에 따라 회원가입을 신청하며, 한주는
                다음과 같은 이용자를 회원으로 등록하지 않는다.
              </p>
              <br />
          ...
          <div class="ex3">
            ...
            <div class="content">
              ...
              <p>
                ...
                이용 방지와 비인가 사용 방지, 가입 의사 확인, 연령확인, 만 19세
                미만 가입 불가, 불만처리 등 민원처리, 고지사항 전달
              </p>
              <p>2. 수집하는 개인정보 항목</p>
              <p>이름, 로그인ID, 비밀번호, 이메일</p>
